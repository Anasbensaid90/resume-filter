...
if __name__=="__main__":
    directory = 'Resume-Parser-Shortlisting-Project-main/Data'
    resume_path = 'Resume-Parser-Shortlisting-Project-main/files/resumes'
    ...
    skills = pd.read_csv('Resume-Parser-Shortlisting-Project-main/Data/skill_red.csv')
